...
VALUES (1, 'Kentia ',
       ...
       (3, 'Ficus Robusta',
        ...
        30.00, 1.40, 20, 12, 1),
       (4, 'Ficus lyrata',
        'Semblable à un arbuste cette plante impressionne avec ses grandes feuilles nervurées d’un beau vert pale. Dépolluante cette plante d’intérieur apprécie le soleil et demande un arrosage régulier. À placer sans hésiter dans un salon ! ',
        22.10, 1.10, 20, 43, 1),
       (5, 'Yucca',
        'Cette jolie plante grasse apportera facilement un côté exotique à n’importe quelles pièces de la maison. Le Yucca aime le soleil et en redemande ! Attention toutefois à ne pas trop l’arroser ! Cette plante se plaira à côté d’une fenêtre et dans une pièce très lumineuse !',
        27.30, 2.10, 20, 32, 1),
       (6, 'Sansevière',
       ...
       (10, 'Senecio Rowleyanus',
        'Le Senecio Rowleyanus, il s’agit d’une plante tombante très décorative dotée de feuilles en forme de petites perles. Cette plante d’intérieur aimera une situation ensoleillée et demandera un arrosage régulier. À exposer sans modération dans toute la maison ! ',
        8.90, 0.30, 20, 10, 1),
       (11, 'Aloe Vera',
        'Cette plante est l’une de nos plantes d’intérieur préférées ! Avec ses longues tiges épaisses, l’Aloe Vera prendra aisément place dans une cuisine ou un salon à vous de choisir. À arroser régulièrement et à placer dans une zone très lumineuse ! ',
        9.90, 0.60, 20, 20, 1),
       (12, 'Campanule',
        'Cette plante vivace, rustique et robuste est facile à cultiver. Elle apprécie les sols légers et plutôt calcaires. On la plante du printemps jusqu\'en automne,
        mais est dite bisanuelle. Cette dernière supporte là la fois les hautes et les basses températures,
        jusqu’à -20°C. Elles préfèrent le soleil, mais supportent également la mi-ombre. Elles se ressèment spontanément.',	21.90,	1.20,	20,	25,	2),
(13,	'Chrysanthème',	'Plante vivace robuste et facile à entretenir,
        elle supporte les aléas climatiques et s’adapte à tous les sols. Une large palette de couleurs arbore ses fleurs qui persistent jusqu’au début de l’hiver. Elles prennent une multitude de formes : pompons, \"japonais\", simples, incurvées.',	18.90,	1.10,	20,	30,	2),
       (14, 'Euphorbe',
        'Cette plante à l’allure exotique qui peut aller du vert au jaune est simple à cultiver et surtout très robuste. Mise en place au printemps ou à la fin de l’été, elle supporte des températures allant jusqu’à -15°C comme des températures chaudes.',
        18.10, 1.40, 20, 32, 2),
        (15, 'Ancolie',
         'Les ancolies sont des plantes herbacées rustiques et vivaces très élégantes. On compte une grande variété d’espèces avec une jolie palette de couleurs. Elle supporte le chaud et le froid, jusqu’à – 20° et apprécie les sols légers et humides.',
         19.60, 1.30, 20, 20, 2),
        (16, 'Lavatères',
         'Cette plante installée dans le jardin au printemps croit très rapidement. Elle s’adapte à tous les sols, bien qu’ayant une préférence pour ceux bien drainés. Elle supporte des températures allant jusqu’à – 15°.',
         19.90, 1.60, 20, 21, 2),
        (17, 'Romarin',
         'Cette plante simple d’entretien offre des petites fleurs bleues. Elle est très décorative. Pouvant se cultiver même sur un sol pauvre, elle supporte de très basses températures allant jusqu’à -21° ainsi que la sécheresse.',
         12.90, 2.20, 20, 30, 2),
...
(21,	'Chaises de jardin',	'Chaise d\'extérieur classique, en métal et bois vendues par lot de 4 unités', 140.00,
         8.00, 20, 60, 4),
